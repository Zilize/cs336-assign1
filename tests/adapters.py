...
def run_transformer_block(
    ...
    """
    block = TransformerBlock(d_model, num_heads, d_ff, True, theta, max_seq_len)
...
def run_transformer_lm(
    ...
    """
    lm = TransformerLM(vocab_size, num_layers, d_model, num_heads, d_ff, use_rope=True, rope_theta=rope_theta,
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    tokenizer_builder = TokenizerBuilder(input_path, vocab_size, special_tokens)
    tokenizer_builder.pre_tokenize()
    tokenizer_builder.merge()
    return tokenizer_builder.vocab, tokenizer_builder.merges
